...
--startup file for user level daemons such as wallpaper
os.execute("/home/michael/.startup")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "main", "www", "dev", "office", "games", "media", "7", "8", "9" }, s, awful.layout.layouts[1])
